...
#[Route('/pharmacy/livraison/future')]
class LivraisonFutureController extends AbstractController
{
    private $em;
    private $api;
    ...
    #[Route('/', name: 'app_pharmacy_livraison_future')]
    public function index(Request $request): Response
    {
        ...
        return $this->render('pharmacy/livraison_future/index.html.twig', [
            'operations' => $operations,
            'modules' => $modules,
        ]);
    }

    #[Route('/list', name: 'app_pharmacy_livraison_future_list', options: ['expose' => true])]
    public function app_pharmacy_livraison_future_list(Request $request): Response
    {
        $operations = $this->api->check($this->getUser(), 'app_pharmacy_livraison_future', $this->em, $request);
        ...
        $queryBuilder = $this->em->createQueryBuilder()
            ->select('livCab.id ,livCab.code as code_liv_cab, livCab.date as date_liv, demandeCab.code as code_dem_cab, demandeCab.date as date_dem, demandeCab.patient, demandeCab.dossierPatient, status.designation as statut_liv, livCab.dateFuture')
    ...
    #[Route('/details', name: 'app_pharmacy_livraison_future_details', options: ['expose' => true])]
    public function app_pharmacy_livraison_future_details(Request $request): Response
    {
    ...
    #[Route('/livrer', name: 'app_pharmacy_livraison_future_livrer', options: ['expose' => true])]
    public function app_pharmacy_livraison_future_livrer(Request $request): Response
    {
    ...
    #[Route('/observation', name: 'app_pharmacy_livraison_future_observation', options: ['expose' => true])]
    public function app_pharmacy_livraison_future_observation(Request $request): Response
    {
