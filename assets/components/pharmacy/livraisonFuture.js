$(document).ready(function () {
        ...
        if (e.key === 'Enter') {
            ...
            try {
                const request = await axios.post(
                    Routing.generate('app_pharmacy_livraison_future_details', { codeLivraison: inputValue })
                );
    ...
    if ($.fn.dataTable.isDataTable("#list_Livraison_future")) {
    ...
    var table = $("#list_Livraison_future").DataTable({
        ...
        columns: [
            ...
            { name: "livCab.dateFuture", data: "dateFuture" },
        ...
        initComplete: function () {
            ...
            $('#list_Livraison_future tbody').on('change', 'input.selectLivraison', function () {
                var id = $(this).data('id');
    ...
    function updateSelectAllCheckboxState() {
        var allChecked = $("#list_Livraison_future tbody input.selectLivraison").length === $("#list_Livraison_future tbody input.selectLivraison:checked").length;
    ...
    $('body').on('click', '.detailsLiv', async function (e) {
        ...
        try {
            const request = await axios.post(
                Routing.generate('app_pharmacy_livraison_future_details', { idLivraison: id_livraison })
            );
            const response = await request.data;
            $("#detailsModal #detailsBody").html("");
            $("#detailsModal #detailsBody").html(response["detailLivraison"]);
    ...
    const livrerLivraison = async (id_livraison) => {
        try {
            ...
            const request = await axios.post(
                Routing.generate('app_pharmacy_livraison_future_livrer',{
    ...
    $('body').on('click', '#saveOBS', async function (e) {
        ...
        try {
            ...
            const request = await axios.post(
                Routing.generate('app_pharmacy_livraison_future_observation',{
